<template>
  <div class="cursor-auto  z-10 bsf14-wrap bsf14-dynamic-styles" :class="{'bg-beige': $store.state.theme==='bsf13', 'bg-offWhite': $store.state.theme=='bsf14'}">
    <a href="#main" class="sr-only focus:not-sr-only">Skip to content</a>
    <Festival24SiteHeader />
    <Festival24Tabs />
    <main id="main" class="site-wrapper bg-offWhite">
...
export default {
  ...
  mixins: [scrollToHash],
  mounted () {
    this.$store.commit('setTheme', 'bsf14')
